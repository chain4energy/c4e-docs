...
- [Run a node](../quickstartun_node.md) {prereq}
...
You will also need to install Ethermint. Check this [document](../quickstartart/install-binary.md) for the full instructions.
...
::: tip
For further information on how to run a node, please refer to [this](../quickstartun_node.md) quickstart document.
:::
...
Learn how to connect Ethermint to [Metamask]() {hide}
