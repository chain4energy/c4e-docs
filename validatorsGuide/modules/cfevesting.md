...
1. [**Concept**](cfevesting.md#concepts)
2. [**Params**](cfevesting.md#parameters)
3. [**State**](cfevesting.md#state)
4. [**Messages**](cfevesting.md#messages)
5. [**Events**](cfevesting.md#events)
6. [**Queries**](cfevesting.md#queries)
7. [**Invariants**](cfevesting.md#invariants)
8. [**Genesis validations**](cfevesting.md#genesis-validations)
...
* vesting type - vesting type used by vesting pool (see [**Vesting Type**](cfevesting.md#vesting-type))
* lock start - time of pool creation
* lock end - unlocking time (end of lock period)
* initially\_locked - amount of tokens locked initially in the pool
* withdrawn - amount of tokens that were already withdrawn from the pool (currently all available (available = initially\_locked - sent) tokens can be withdrawn by the owner only after lock end time)
...
| vesting\_pools | List of VestingPool types | Vesting pools of the owner |
...
| vesting\_type     | string                    | vesting type used by vesting pool (see [**Vesting Type**](cfevesting.md#vesting-type)) |
| lock\_start       | time.Duration             | time of pool creation                                                                  |
| lock\_end         | time.Duration             | unlocking time (end of lock period)                                                    |
| initially\_locked | math.Int                  | amount of tokens locked initially in the pool                                          |
...
| lockup\_period  | time.Duration | period of time when all tokens are locked          |
| vesting\_period | time.Duration | period of time when tokens are are linearly vested |
...
| ------------------- | ------------- | ------------------------------------------------------ |
| EventNewVestingPool | owner         | {owner\_address}                                       |
| EventNewVestingPool | name          | {vesting\_pool\_name}                                  |
| EventNewVestingPool | amount        | {vesting\_pool\_amount}                                |
| EventNewVestingPool | duration      | {lock\_duration}                                       |
| EventNewVestingPool | vesting\_type | {vesting\_type\_name}                                  |
...
| transfer            | sender        | {owner\_address}                                       |
...
| EventNewVestingPeriodFromVestingPool | owner               | {owner\_address}                                                                            |
| EventNewVestingPeriodFromVestingPool | address             | {vesting\_account\_address}                                                                 |
| EventNewVestingPeriodFromVestingPool | vesting\_pool\_name | {source\_vesting\_pool\_name}                                                               |
| EventNewVestingPeriodFromVestingPool | amount              | {amount\_to\_send\_to\_new\_vesting\_account}                                               |
| EventNewVestingPeriodFromVestingPool | restart\_vesting    | {restart\_vesting} see [**Send To Vesting Account**](cfevesting.md#send-to-vesting-account) |
| EventNewVestingPeriodFromVestingPool | period\_id          | {new\_period\_id}                                                                           |
...
| Type                   | Attribute Key       | Attribute Value                                           |
| ---------------------- | ------------------- | --------------------------------------------------------- |
| EventWithdrawAvailable | owner               | {owner\_address}                                          |
| EventWithdrawAvailable | vesting\_pool\_name | {source\_vesting\_pool\_name}                             |
| EventWithdrawAvailable | amount              | {withdrawn\_amount}                                       |
